...
`dhul-qarnayn`, `saint-george` (all legend-transmission timelines; Saint Guinefort a further candidate member). **Standalone single-doctrine families** (their own `<h2 id="family-…">`,
